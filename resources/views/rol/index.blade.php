        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 rounded-lg">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md rounded-lg overflow-hidden">
                    ...
                    <x-slot name="alert">
                        <x-alert>{{ session('alert-rol') }}</x-alert>
                    </x-slot>
                    @endif
                            ...
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search"
                                        ...
                                        placeholder="Buscar rol" required="">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <div class="uppercase">
                                <div class="p-4 grid grid-cols-2 gap-4 mb-4 md:grid-cols-4">
                                    ...
                                    <div class="max-w-sm rounded-lg shadow bg-yellow-500">
                                        ...
                                        <button
                                            class="block max-w-sm p-2 h-56 bg-yellow-500 hover:bg-yellow-400 border border-gray-200 rounded-lg shadow dark:border-gray-700"
                                            type="button">
                                            <h5 class="text-xl font-bold tracking-tight text-white">
                                            ...
                                            <figure
                                                ...
                                                <img class="rounded-lg h-28 w-28 mx-auto"
                                                    src="https://th.bing.com/th/id/OIP.m-cHuMECEUfOuSTyMedaawAAAA?pid=ImgDet&rs=1"
                                                    alt="rol">
                                            </figure>
                                        </button>
                                    </div>
