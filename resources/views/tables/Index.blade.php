            ...
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <div class="p-4">
                            <div
                                class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700 mt-14">

                                <div class="grid grid-cols-2 gap-4 mb-4 md:grid-cols-4">
                                    @foreach ($tables as $table)
                                        <div
                                            class="w-full max-w-md p-4 h-48 @if ($table['status'] == '1') bg-green-500 @endif {{-- Disponible --}}
                                            @if ($table['status'] == '2') bg-yellow-300 @endif  {{-- Ocupado --}}
                                            @if ($table['status'] == '0') bg-gray-500 @endif    {{-- Desactivo --}}
                                            border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                                            <div class="flex items-center justify-between mb-4">
                                                <h5 class="text-xl font-bold leading-none text-white dark:text-white">
                                                    {{ $table['nombre'] }}</h5>
                                                <button id="{{ $table['id'] }}-dropdown-button"
                                                    data-dropdown-toggle="{{ $table['id'] }}-dropdown"
                                                    class="inline-flex items-center p-0.5 text-sm font-medium text-center text-white hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                                    type="button">
                                                    ...
                                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                        ...
                                                        <li>
                                                            ...
                                                            <button id="show{{ $table['id'] }}ModalButton"
                                                                data-modal-toggle="show{{ $table['id'] }}Modal"
                                                                type="button"
                                                        ...
                                                        <li>
                                                            ...
                                                            <button id="edit{{ $table['id'] }}ModalButton"
                                                                data-modal-toggle="edit{{ $table['id'] }}Modal"
                                                                type="button"
                                                                class=" w-full block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                                Editar
                                                            </button>
                                    ...
                                    @endforeach
                                    <div
                                        class="flex items-center justify-center h-48 rounded bg-green-500 dark:bg-gray-800">
                            ...
                            <div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input name="status" id="status" type="checkbox" value="1"
                                        class="sr-only peer" @if ($table['status'] == '1') checked @endif>
                                    <div
                ...
                <div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input name="status" id="status" type="checkbox" value="1" class="sr-only peer"
                            @if ($table['status'] == '1' || $table['status'] == '2') checked @endif @if ($table['status'] == '2') disabled @endif>
                        <div
                            class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                        </div>
                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
